...
class CommandHandler():
    ...
    def log_command(self, commandToLog, result):
        ...
        if result[1].strip() == '':
            commandToLog['error_reason'] = "N/A"
        else:
            commandToLog['error_reason'] = result[1]
        self.parentWindow.LogPageHandler.logCommand(commandToLog)
    ...
    def create_default_command_list(self):
        default_commands = [{"name":"Steam","speech":"open steam","enabled":"True","category":"Default","type":"Program","target":"C:\\Program Files (x86)\\Steam\\Steam.exe"},{"name":"Volume Up","speech":"volume up","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Volume Down","speech":"volume down","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Mute Volume","speech":"mute volume","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Unmute Volume","speech":"unmute volume","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Max Volume","speech":"maximum volume","enabled":"False","category":"Default","type":"Utility","target":"N/A"},{"name":"Min Volume","speech":"minimum volume","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Mute Microphone","speech":"mute microphone","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Min Brightness","speech":"minimum brightness","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Max Brightness","speech":"maximum brightness","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Brightness Up","speech":"brightness up","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Brightness Down","speech":"brightness down","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Close Active Window","speech":"close window","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Lock Computer","speech":"lock computer","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Restart Computer","speech":"restart computer","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Shutdown Computer","speech":"shutdown computer","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Pause Music","speech":"pause music","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Play Music","speech":"play music","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Next Song","speech":"next song","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Previous Song","speech":"previous song","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Rewind Song","speech":"rewind song","enabled":"True","category":"Default","type":"Utility","target":"N/A"},{"name":"Browser","speech":"open browser","enabled":"True","category":"Default","type":"Browser","target":"google.com"}]
        #oughhhh this is such an ugly line
